...
export const PROVIDER_OPS_FIXTURE: StageOpsFixture = {
  ...
  events: [
    ...
    ev('provider', 'needs-provider-confirm', 'helen-park', 'Helen Park', 'August 10, 2026 at 8:52 AM', 'Awaiting case manager confirmation', 'open', 'Waiting 9h'),
    ...
    ev('provider', 'needs-provider-confirm', 'betty-hayes', 'Betty Hayes', 'August 9, 2026 at 2:02 PM', 'No eligible provider - Nicole review required', 'open', 'Waiting 1d'),
