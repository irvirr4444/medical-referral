...
export const END_OF_DAY_OPS_FIXTURE: StageOpsFixture = {
  ...
  events: [
    ...
    ev('end-of-day', 'inconsistencies', 'frank-owens', 'Frank Owens', 'August 10, 2026 at 5:01 PM', 'CM identified - scheduled status blank', 'open', 'Opened today'),
    ev('end-of-day', 'exceptions-opened', 'frank-owens', 'Frank Owens', 'August 10, 2026 at 5:02 PM', 'Lead and CM follow-up started', 'open', 'Opened today'),
    ev('end-of-day', 'management-notified', 'frank-owens', 'Frank Owens', 'August 10, 2026 at 5:03 PM', 'Unresolved blocker escalated to Nicole', 'resolved'),
    ...
    ev('end-of-day', 'exceptions-opened', 'george-chen', 'George Chen', 'August 10, 2026 at 5:02 PM', 'Lead and CM follow-up started', 'open', 'Opened today'),
    ...
    ev('end-of-day', 'exceptions-opened', 'linda-nguyen', 'Linda Nguyen', 'August 9, 2026 at 5:02 PM', 'Lead and CM follow-up started', 'open', 'Waiting 1d'),
    ev('end-of-day', 'management-notified', 'linda-nguyen', 'Linda Nguyen', 'August 9, 2026 at 5:03 PM', 'Unresolved blocker escalated once', 'resolved'),
    ...
    ev('end-of-day', 'exceptions-opened', 'robert-williams', 'Robert Williams', 'August 10, 2026 at 5:06 PM', 'Lead and CM follow-up started', 'open', 'Opened today'),
    ev('end-of-day', 'management-notified', 'robert-williams', 'Robert Williams', 'August 10, 2026 at 5:07 PM', 'Unresolved blocker escalated to Nicole', 'resolved'),
  ],
}
