...
export const ASSIGNMENT_OPS_FIXTURE: StageOpsFixture = {
  stageId: 'assignment',
  events: [
    ev('assignment', 'ready-assignment', 'marcus-feldman', 'Marcus Feldman', 'August 10, 2026 at 9:30 AM', 'Handoff complete · ready to assign owner', 'open', 'Waiting 8h'),
    ev('assignment', 'territory-matched', 'marcus-feldman', 'Marcus Feldman', 'August 10, 2026 at 9:31 AM', 'Gardena territory · Cole suggested', 'resolved'),
    ev('assignment', 'needs-owner-confirm', 'marcus-feldman', 'Marcus Feldman', 'August 10, 2026 at 9:32 AM', 'Awaiting marketer confirmation', 'open', 'Waiting 8h'),

    ev('assignment', 'ready-assignment', 'david-ruiz', 'David Ruiz', 'August 10, 2026 at 11:00 AM', 'Ready to assign', 'open', 'Waiting 6h'),
    ev('assignment', 'territory-matched', 'david-ruiz', 'David Ruiz', 'August 10, 2026 at 11:01 AM', 'Coastal LA · Carla suggested', 'resolved'),
    ev('assignment', 'needs-owner-confirm', 'david-ruiz', 'David Ruiz', 'August 10, 2026 at 11:02 AM', 'Border territory · dual owner candidates', 'open', 'Waiting 6h'),
    ...
    ev('assignment', 'ready-assignment', 'betty-hayes', 'Betty Hayes', 'August 8, 2026 at 1:10 PM', 'Ready to assign', 'open', 'Waiting 2d'),
    ev('assignment', 'territory-matched', 'betty-hayes', 'Betty Hayes', 'August 8, 2026 at 1:11 PM', 'Unknown ZIP · no territory', 'resolved'),
    ev('assignment', 'needs-owner-confirm', 'betty-hayes', 'Betty Hayes', 'August 8, 2026 at 1:12 PM', 'Manual owner selection required', 'open', 'Waiting 2d'),
    ...
    ev('assignment', 'territory-matched', 'maria-alvarez', 'Maria Alvarez', 'August 10, 2026 at 10:16 AM', 'Riverside · Ana suggested', 'resolved'),
  ],
}
