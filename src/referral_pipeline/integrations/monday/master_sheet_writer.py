...
from referral_pipeline.integrations.monday.write_config import MasterSheetWriteConfig, _optional_string
...
def _mapped_columns(
    ...
    *,
    ...
    if config.write_referral_received and config.referral_received_column and received_value:
        ...
        notes.append(
            {
                "field": "referral_received",
                "reason": "stored_in_comments_and_item_update_column_write_not_enabled",
            }
        )
