...
| [`create_patient/`](create_patient/) | Fill-only guards + synthetic TEST data (`drk_emr.create_patient`) |
...
These are unit tests only (no live Chrome login). Live runs use the package CLIs under `src/drk_emr/`.
